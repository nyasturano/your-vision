...
export default function Page() {
    ...
    return <div className="content">
        ...
        <div className="flex flex-col lg:flex-row lg:items-center items-start my-12 lg:space-x-16">
                            ...
                            <Tab.Panel>
                                <div className="flex flex-col lg:flex-row w-full lg:h-[600px] h-[800px]">
                                    ...
                                    <div className="w-full h-full">
                                        <Map interactive={false} callback={setNodes} target={[45.0430196, 38.9493056]}/>
                                    </div>
                                    {/* filter */}
